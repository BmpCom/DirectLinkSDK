...
public class Interstitial_FullAd_Fb_Admob {

    public static InterstitialAd mInterstitialAd_admob;
    public static AdManagerInterstitialAd adManagerInterstitialAd;

    public static void ShowAd_FullFb(Activity source_class, Interstitial_Full_Ads.AdCloseListener adCloseListener, String oraganictype) {
    ...
    public static void ShowAd_Full(Activity source_class, Interstitial_Full_Ads.AdCloseListener adCloseListener, Custom_Prog_Dialog customProgressDialog, String oraganictype) {
    ...
    public static void ShowAd_FullAdmob(Activity source_class, Interstitial_Full_Ads.AdCloseListener adCloseListener, Custom_Prog_Dialog customProgressDialog, String oraganictype) {
        Apps_Preference preference = new Apps_Preference(source_class);
        if (preference.get_Ad_Status().equalsIgnoreCase("on")) {
    ...
    private static void adFailedToLoadG(Activity source_class, Interstitial_Full_Ads.AdCloseListener adCloseListener, Custom_Prog_Dialog customProgressDialog, Apps_Preference preference, String oraganictype) {
        Apps_Preference.isFullScreenShow = false;
        if (customProgressDialog.isShowing()) {
            customProgressDialog.dismiss();
        }
    ...
    public static void ShowAd_FullAdx(Activity source_class, Interstitial_Full_Ads.AdCloseListener adCloseListener, Custom_Prog_Dialog customProgressDialog, String oraganictype) {
        Apps_Preference preference = new Apps_Preference(source_class);
        if (preference.get_Ad_Status().equalsIgnoreCase("on")) {
